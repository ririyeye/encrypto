...
add_requires("libarchive", {configs = {shared = false}})
add_requires("zlib", {configs = {shared = false}})
add_requires("bzip2", {configs = {shared = false}})
add_requires("zstd", {configs = {shared = false}})
add_requires("lz4", {configs = {shared = false}})
...
target("enc")
    ...
    add_packages("mbedtls", "libarchive")
    add_deps("key_data")
